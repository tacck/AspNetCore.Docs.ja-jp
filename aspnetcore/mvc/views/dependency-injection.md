...
<span data-ttu-id="43ec2-111">*:::no-loc(appsettings.json):::* 値は、ビューに直接挿入できます。</span><span class="sxs-lookup"><span data-stu-id="43ec2-111">*:::no-loc(appsettings.json):::* values can be injected directly into a view.</span></span>

<span data-ttu-id="43ec2-112">ファイルの例 *:::no-loc(appsettings.json):::* :</span><span class="sxs-lookup"><span data-stu-id="43ec2-112">Example of an *:::no-loc(appsettings.json):::* file:</span></span>

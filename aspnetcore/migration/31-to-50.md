...
1. ファイルで `Shared/MainLayout.razor` 、要素内のすべてのコンテンツを、 `<div>` `class` 次のようにブロックし `page` ます。
...
1. で `wwwroot/index.html` 、コンポーネントを読み込む要素を変更し `App` ます。

<span data-ttu-id="a68d0-101">コンポーネント`FetchData`では、次の方法を示しています。</span><span class="sxs-lookup"><span data-stu-id="a68d0-101">The `FetchData` component shows how to:</span></span>

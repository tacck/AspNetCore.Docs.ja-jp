<span data-ttu-id="f0d56-101">コンポーネント`FetchData`は、次の方法を示しています。</span><span class="sxs-lookup"><span data-stu-id="f0d56-101">The `FetchData` component shows how to:</span></span>

<span data-ttu-id="c1701-101">`FetchData` コンポーネントは次の方法を示します。</span><span class="sxs-lookup"><span data-stu-id="c1701-101">The `FetchData` component shows how to:</span></span>

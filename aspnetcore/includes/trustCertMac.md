<span data-ttu-id="c5b35-101">Visual Studio for Mac で次のポップアップが表示されます。</span><span class="sxs-lookup"><span data-stu-id="c5b35-101">Visual Studio for Mac displays the following popup:</span></span>

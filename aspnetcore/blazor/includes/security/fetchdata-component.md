<span data-ttu-id="7fe59-101">`FetchData` コンポーネントは次の方法を示します。</span><span class="sxs-lookup"><span data-stu-id="7fe59-101">The `FetchData` component shows how to:</span></span>

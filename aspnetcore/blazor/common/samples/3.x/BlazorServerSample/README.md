# <a name="blazor-server-sample-app"></a><span data-ttu-id="b8c85-101">Blazor サーバー サンプル アプリ</span><span class="sxs-lookup"><span data-stu-id="b8c85-101">Blazor Server Sample App</span></span>

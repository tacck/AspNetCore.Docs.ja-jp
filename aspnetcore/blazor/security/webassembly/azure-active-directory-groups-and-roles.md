...
<span data-ttu-id="aeadc-107">Azure Active Directory (AAD) には、ASP.NET Core Identity と組み合わせることができる承認方法がいくつか用意されています。</span><span class="sxs-lookup"><span data-stu-id="aeadc-107">Azure Active Directory (AAD) provides several authorization approaches that can be combined with ASP.NET Core Identity:</span></span>
...
## <a name="user-defined-groups-and-administrator-roles"></a><span data-ttu-id="aeadc-123">ユーザー定義グループと管理者ロール</span><span class="sxs-lookup"><span data-stu-id="aeadc-123">User-defined groups and Administrator Roles</span></span>
...
<span data-ttu-id="aeadc-137">`CustomUserAccount.cs`:</span><span class="sxs-lookup"><span data-stu-id="aeadc-137">`CustomUserAccount.cs`:</span></span>
...
<span data-ttu-id="aeadc-166">`CustomAccountFactory.cs`:</span><span class="sxs-lookup"><span data-stu-id="aeadc-166">`CustomAccountFactory.cs`:</span></span>
...
<span data-ttu-id="aeadc-180">[`AuthorizeView` コンポーネント](xref:blazor/security/index#authorizeview-component)ではポリシーが使用されます。</span><span class="sxs-lookup"><span data-stu-id="aeadc-180">The [`AuthorizeView` component](xref:blazor/security/index#authorizeview-component) works with the policy:</span></span>
...
* <span data-ttu-id="aeadc-194">`access_as_user` スコープを要求する。</span><span class="sxs-lookup"><span data-stu-id="aeadc-194">Require the the `access_as_user` scope.</span></span>
...
<span data-ttu-id="aeadc-206">次に例を示します。</span><span class="sxs-lookup"><span data-stu-id="aeadc-206">For example:</span></span>
...
<span data-ttu-id="aeadc-250"><xref:Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents> を構成する場合:</span><span class="sxs-lookup"><span data-stu-id="aeadc-250">When configuring <xref:Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents>:</span></span>
...
<span data-ttu-id="aeadc-257">前の例の場合:</span><span class="sxs-lookup"><span data-stu-id="aeadc-257">In the preceding example:</span></span>
...
* <span data-ttu-id="aeadc-268">次のコード行に対して:</span><span class="sxs-lookup"><span data-stu-id="aeadc-268">For the code line:</span></span>
...
<span data-ttu-id="aeadc-276">以下の例では、次の 2 つのロールがアプリに構成されているものとします。</span><span class="sxs-lookup"><span data-stu-id="aeadc-276">The following example assumes that an app is configured with two roles:</span></span>
...
<span data-ttu-id="aeadc-286">この時点でコンポーネントの承認方法が機能しています。</span><span class="sxs-lookup"><span data-stu-id="aeadc-286">Component authorization approaches are functional at this point.</span></span> <span data-ttu-id="aeadc-287">コンポーネント内のすべての承認メカニズムで、`admin` ロールを使用してユーザーを承認できます。</span><span class="sxs-lookup"><span data-stu-id="aeadc-287">Any of the authorization mechanisms in components can use the `admin` role to authorize the user:</span></span>
...
<span data-ttu-id="aeadc-332">ディレクトリ閲覧者</span><span class="sxs-lookup"><span data-stu-id="aeadc-332">Directory readers</span></span> | <span data-ttu-id="aeadc-333">e1fc84a6-7762-4b9b-8e29-518b4adbc23b</span><span class="sxs-lookup"><span data-stu-id="aeadc-333">e1fc84a6-7762-4b9b-8e29-518b4adbc23b</span></span>
<span data-ttu-id="aeadc-334">Dynamics 365 管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-334">Dynamics 365 administrator</span></span> | <span data-ttu-id="aeadc-335">f20a9cfa-9fdf-49a8-a977-1afe446a1d6e</span><span class="sxs-lookup"><span data-stu-id="aeadc-335">f20a9cfa-9fdf-49a8-a977-1afe446a1d6e</span></span>
<span data-ttu-id="aeadc-336">Exchange 管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-336">Exchange administrator</span></span> | <span data-ttu-id="aeadc-337">b2ec2cc0-d5c9-4864-ad9b-38dd9dba2652</span><span class="sxs-lookup"><span data-stu-id="aeadc-337">b2ec2cc0-d5c9-4864-ad9b-38dd9dba2652</span></span>
<span data-ttu-id="aeadc-338">外部 IdentityID プロバイダー管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-338">External Identity Provider administrator</span></span> | <span data-ttu-id="aeadc-339">febfaeb4-e478-407a-b4b3-f4d9716618a2</span><span class="sxs-lookup"><span data-stu-id="aeadc-339">febfaeb4-e478-407a-b4b3-f4d9716618a2</span></span>
<span data-ttu-id="aeadc-340">全体管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-340">Global administrator</span></span> | <span data-ttu-id="aeadc-341">a45ba61b-44db-462c-924b-3b2719152588</span><span class="sxs-lookup"><span data-stu-id="aeadc-341">a45ba61b-44db-462c-924b-3b2719152588</span></span>
<span data-ttu-id="aeadc-342">グローバル閲覧者</span><span class="sxs-lookup"><span data-stu-id="aeadc-342">Global reader</span></span> | <span data-ttu-id="aeadc-343">f6903b21-6aba-4124-b44c-76671796b9d5</span><span class="sxs-lookup"><span data-stu-id="aeadc-343">f6903b21-6aba-4124-b44c-76671796b9d5</span></span>
<span data-ttu-id="aeadc-344">グループ管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-344">Groups administrator</span></span> | <span data-ttu-id="aeadc-345">158b3e5a-d89d-460b-92b5-3b34985f0197</span><span class="sxs-lookup"><span data-stu-id="aeadc-345">158b3e5a-d89d-460b-92b5-3b34985f0197</span></span>
<span data-ttu-id="aeadc-346">ゲスト招待元</span><span class="sxs-lookup"><span data-stu-id="aeadc-346">Guest inviter</span></span> | <span data-ttu-id="aeadc-347">4c730a1d-cc22-44af-8f9f-4eec635c7502</span><span class="sxs-lookup"><span data-stu-id="aeadc-347">4c730a1d-cc22-44af-8f9f-4eec635c7502</span></span>
<span data-ttu-id="aeadc-348">ヘルプデスク管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-348">Helpdesk administrator</span></span> | <span data-ttu-id="aeadc-349">108678c8-6628-44e1-8d01-caf598a6a5f5</span><span class="sxs-lookup"><span data-stu-id="aeadc-349">108678c8-6628-44e1-8d01-caf598a6a5f5</span></span>
<span data-ttu-id="aeadc-350">Intune 管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-350">Intune administrator</span></span> | <span data-ttu-id="aeadc-351">79950741-23fa-4189-b2cb-46640601c497</span><span class="sxs-lookup"><span data-stu-id="aeadc-351">79950741-23fa-4189-b2cb-46640601c497</span></span>
<span data-ttu-id="aeadc-352">Kaizala 管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-352">Kaizala administrator</span></span> | <span data-ttu-id="aeadc-353">d6322af2-48e7-42e0-8c68-0bbe31af3412</span><span class="sxs-lookup"><span data-stu-id="aeadc-353">d6322af2-48e7-42e0-8c68-0bbe31af3412</span></span>
<span data-ttu-id="aeadc-354">ライセンス管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-354">License administrator</span></span> | <span data-ttu-id="aeadc-355">3355458a-e423-44bf-8b98-4ac5e572cea5</span><span class="sxs-lookup"><span data-stu-id="aeadc-355">3355458a-e423-44bf-8b98-4ac5e572cea5</span></span>
<span data-ttu-id="aeadc-356">メッセージ センターのプライバシー閲覧者</span><span class="sxs-lookup"><span data-stu-id="aeadc-356">Message center privacy reader</span></span> | <span data-ttu-id="aeadc-357">6395db95-9fb8-42b9-b1ed-30a2405eee6f</span><span class="sxs-lookup"><span data-stu-id="aeadc-357">6395db95-9fb8-42b9-b1ed-30a2405eee6f</span></span>
<span data-ttu-id="aeadc-358">メッセージ センター閲覧者</span><span class="sxs-lookup"><span data-stu-id="aeadc-358">Message center reader</span></span> | <span data-ttu-id="aeadc-359">fd5d37b8-4e24-434b-9e63-70ed3b759a16</span><span class="sxs-lookup"><span data-stu-id="aeadc-359">fd5d37b8-4e24-434b-9e63-70ed3b759a16</span></span>
<span data-ttu-id="aeadc-360">Office アプリ管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-360">Office apps administrator</span></span> | <span data-ttu-id="aeadc-361">5f3870cd-b042-4f93-86d7-c9d77c664dc7</span><span class="sxs-lookup"><span data-stu-id="aeadc-361">5f3870cd-b042-4f93-86d7-c9d77c664dc7</span></span>
<span data-ttu-id="aeadc-362">パスワード管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-362">Password administrator</span></span> | <span data-ttu-id="aeadc-363">466e48b7-5d66-4ae5-8911-1a118de74941</span><span class="sxs-lookup"><span data-stu-id="aeadc-363">466e48b7-5d66-4ae5-8911-1a118de74941</span></span>
<span data-ttu-id="aeadc-364">Power BI 管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-364">Power BI administrator</span></span> | <span data-ttu-id="aeadc-365">984e83b8-8337-4255-91a1-acb663175ab4</span><span class="sxs-lookup"><span data-stu-id="aeadc-365">984e83b8-8337-4255-91a1-acb663175ab4</span></span>
<span data-ttu-id="aeadc-366">Power Platform 管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-366">Power platform administrator</span></span> | <span data-ttu-id="aeadc-367">76d6f95e-9a15-4d7d-8d21-00de00faf9fd</span><span class="sxs-lookup"><span data-stu-id="aeadc-367">76d6f95e-9a15-4d7d-8d21-00de00faf9fd</span></span>
<span data-ttu-id="aeadc-368">特権認証管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-368">Privileged authentication administrator</span></span> | <span data-ttu-id="aeadc-369">0829f731-b46d-419f-9742-aeb122367d11</span><span class="sxs-lookup"><span data-stu-id="aeadc-369">0829f731-b46d-419f-9742-aeb122367d11</span></span>
<span data-ttu-id="aeadc-370">特権ロール管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-370">Privileged role administrator</span></span> | <span data-ttu-id="aeadc-371">f20a725a-d1c8-4107-83ea-1171c97d00c7</span><span class="sxs-lookup"><span data-stu-id="aeadc-371">f20a725a-d1c8-4107-83ea-1171c97d00c7</span></span>
<span data-ttu-id="aeadc-372">レポート閲覧者</span><span class="sxs-lookup"><span data-stu-id="aeadc-372">Reports reader</span></span> | <span data-ttu-id="aeadc-373">54635450-e8ed-4f2d-9632-07db2517b4de</span><span class="sxs-lookup"><span data-stu-id="aeadc-373">54635450-e8ed-4f2d-9632-07db2517b4de</span></span>
<span data-ttu-id="aeadc-374">Search 管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-374">Search administrator</span></span> | <span data-ttu-id="aeadc-375">c770a2f1-c9ba-4e60-9176-9f52b1eb1a31</span><span class="sxs-lookup"><span data-stu-id="aeadc-375">c770a2f1-c9ba-4e60-9176-9f52b1eb1a31</span></span>
<span data-ttu-id="aeadc-376">Search エディター</span><span class="sxs-lookup"><span data-stu-id="aeadc-376">Search editor</span></span> | <span data-ttu-id="aeadc-377">6a6858c6-5f0d-44ac-87c7-0190fbedd271</span><span class="sxs-lookup"><span data-stu-id="aeadc-377">6a6858c6-5f0d-44ac-87c7-0190fbedd271</span></span>
<span data-ttu-id="aeadc-378">セキュリティ管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-378">Security administrator</span></span> | <span data-ttu-id="aeadc-379">20fa50e3-6531-44d8-bd39-b251420568ad</span><span class="sxs-lookup"><span data-stu-id="aeadc-379">20fa50e3-6531-44d8-bd39-b251420568ad</span></span>
<span data-ttu-id="aeadc-380">セキュリティ オペレーター</span><span class="sxs-lookup"><span data-stu-id="aeadc-380">Security operator</span></span> | <span data-ttu-id="aeadc-381">43aae017-8e51-4188-91ab-e6debd572800</span><span class="sxs-lookup"><span data-stu-id="aeadc-381">43aae017-8e51-4188-91ab-e6debd572800</span></span>
<span data-ttu-id="aeadc-382">セキュリティ閲覧者</span><span class="sxs-lookup"><span data-stu-id="aeadc-382">Security reader</span></span> | <span data-ttu-id="aeadc-383">45035cd3-fd97-4250-8197-3a53d3562d9b</span><span class="sxs-lookup"><span data-stu-id="aeadc-383">45035cd3-fd97-4250-8197-3a53d3562d9b</span></span>
<span data-ttu-id="aeadc-384">サービス サポート管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-384">Service support administrator</span></span> | <span data-ttu-id="aeadc-385">2c92cf45-c914-48f8-9bf9-fc14b28818ab</span><span class="sxs-lookup"><span data-stu-id="aeadc-385">2c92cf45-c914-48f8-9bf9-fc14b28818ab</span></span>
<span data-ttu-id="aeadc-386">SharePoint 管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-386">SharePoint administrator</span></span> | <span data-ttu-id="aeadc-387">e1c32229-875e-461d-ae24-3cb99116e86c</span><span class="sxs-lookup"><span data-stu-id="aeadc-387">e1c32229-875e-461d-ae24-3cb99116e86c</span></span>
<span data-ttu-id="aeadc-388">Skype for Business 管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-388">Skype for Business administrator</span></span> | <span data-ttu-id="aeadc-389">0a8cee12-e21d-43ef-abd9-f1ea85710e30</span><span class="sxs-lookup"><span data-stu-id="aeadc-389">0a8cee12-e21d-43ef-abd9-f1ea85710e30</span></span>
<span data-ttu-id="aeadc-390">Teams 通信管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-390">Teams Communications Administrator</span></span> | <span data-ttu-id="aeadc-391">2393e455-6e13-4743-9f52-63fcec2b6a9c</span><span class="sxs-lookup"><span data-stu-id="aeadc-391">2393e455-6e13-4743-9f52-63fcec2b6a9c</span></span>
<span data-ttu-id="aeadc-392">Teams 通信サポート エンジニア</span><span class="sxs-lookup"><span data-stu-id="aeadc-392">Teams Communications Support Engineer</span></span> | <span data-ttu-id="aeadc-393">802dd94e-d717-46f6-af98-b9167071e9fc</span><span class="sxs-lookup"><span data-stu-id="aeadc-393">802dd94e-d717-46f6-af98-b9167071e9fc</span></span>
<span data-ttu-id="aeadc-394">Teams 通信スペシャリスト</span><span class="sxs-lookup"><span data-stu-id="aeadc-394">Teams Communications Specialist</span></span> | <span data-ttu-id="aeadc-395">ef547281-cf46-4cc6-bcaa-f5eac3f030c9</span><span class="sxs-lookup"><span data-stu-id="aeadc-395">ef547281-cf46-4cc6-bcaa-f5eac3f030c9</span></span>
<span data-ttu-id="aeadc-396">Teams サービス管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-396">Teams Service Administrator</span></span> | <span data-ttu-id="aeadc-397">8846a0be-197b-443a-b13c-11192691fa24</span><span class="sxs-lookup"><span data-stu-id="aeadc-397">8846a0be-197b-443a-b13c-11192691fa24</span></span>
<span data-ttu-id="aeadc-398">ユーザー管理者</span><span class="sxs-lookup"><span data-stu-id="aeadc-398">User administrator</span></span> | <span data-ttu-id="aeadc-399">1f6eed58-7dd3-460b-a298-666f975427a1</span><span class="sxs-lookup"><span data-stu-id="aeadc-399">1f6eed58-7dd3-460b-a298-666f975427a1</span></span>

## <a name="additional-resources"></a><span data-ttu-id="aeadc-400">その他の技術情報</span><span class="sxs-lookup"><span data-stu-id="aeadc-400">Additional resources</span></span>

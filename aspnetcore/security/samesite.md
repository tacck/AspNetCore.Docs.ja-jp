...
## <a name="samesite-and-no-locidentity"></a>SameSite とIdentity
...
| [Cookie認証](xref:Microsoft.Extensions.DependencyInjection.CookieExtensions.AddCookie*) | [CookieAuthenticationOptions.Cookie](xref:Microsoft.AspNetCore.Builder.CookieAuthenticationOptions.CookieName) | `Lax` |
...
### <a name="test-with-no-locelectron"></a>テストに使用するElectron

...
<span data-ttu-id="72aff-108">既存の資格情報でユーザーがサインインできるようになると:</span><span class="sxs-lookup"><span data-stu-id="72aff-108">Enabling users to sign in with their existing credentials:</span></span>

...
---
# <a name="part-4-no-locrazor-pages-with-ef-core-migrations-in-aspnet-core"></a><span data-ttu-id="7aa9a-103">パート 4、ASP.NET Core の Razor ページと EF Core の移行</span><span class="sxs-lookup"><span data-stu-id="7aa9a-103">Part 4, Razor Pages with EF Core migrations in ASP.NET Core</span></span>

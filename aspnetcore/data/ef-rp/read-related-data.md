---
title: 'パート 6、ASP.NET Core の :::no-loc(Razor)::: ページと EF Core - 関連データの読み込み'
author: rick-anderson
description: ':::no-loc(Razor)::: ページと Entity Framework チュートリアル シリーズのパート 6。'
ms.author: riande
ms.custom: mvc
ms.date: 09/28/2019
no-loc:
...
---
# <a name="part-6-no-locrazor-pages-with-ef-core-in-aspnet-core---read-related-data"></a><span data-ttu-id="07406-103">パート 6、ASP.NET Core の :::no-loc(Razor)::: ページと EF Core - 関連データの読み込み</span><span class="sxs-lookup"><span data-stu-id="07406-103">Part 6, :::no-loc(Razor)::: Pages with EF Core in ASP.NET Core - Read Related Data</span></span>
...
<span data-ttu-id="07406-442">*Pages/Instructors/Index.cshtml* :::no-loc(Razor)::: ページの末尾に次のマークアップを追加します。</span><span class="sxs-lookup"><span data-stu-id="07406-442">Add the following markup to the end of the *Pages/Instructors/Index.cshtml* :::no-loc(Razor)::: Page:</span></span>

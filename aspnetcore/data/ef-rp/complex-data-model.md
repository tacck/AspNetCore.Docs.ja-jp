...
---
# <a name="part-5-no-locrazor-pages-with-ef-core-in-aspnet-core---data-model"></a><span data-ttu-id="11b85-103">パート 5、ASP.NET Core の Razor ページと EF Core - データ モデル</span><span class="sxs-lookup"><span data-stu-id="11b85-103">Part 5, Razor Pages with EF Core in ASP.NET Core - Data Model</span></span>

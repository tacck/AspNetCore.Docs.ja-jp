...
---
# <a name="use-aspnet-core-no-locsignalr-with-no-locblazor-webassembly"></a><span data-ttu-id="e8201-103">ASP.NET Core :::no-loc(SignalR)::: を :::no-loc(Blazor WebAssembly)::: と共に使用する</span><span class="sxs-lookup"><span data-stu-id="e8201-103">Use ASP.NET Core :::no-loc(SignalR)::: with :::no-loc(Blazor WebAssembly):::</span></span>
...
<span data-ttu-id="e8201-105">このチュートリアルでは、:::no-loc(Blazor WebAssembly)::: と共に :::no-loc(SignalR)::: を使用してリアルタイム アプリをビルドするための基礎について説明します。</span><span class="sxs-lookup"><span data-stu-id="e8201-105">This tutorial teaches the basics of building a real-time app using :::no-loc(SignalR)::: with :::no-loc(Blazor WebAssembly):::.</span></span> <span data-ttu-id="e8201-106">以下の方法について説明します。</span><span class="sxs-lookup"><span data-stu-id="e8201-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="e8201-107">:::no-loc(Blazor WebAssembly)::: でホストされるアプリ プロジェクトを作成する</span><span class="sxs-lookup"><span data-stu-id="e8201-107">Create a :::no-loc(Blazor WebAssembly)::: Hosted app project</span></span>
> * <span data-ttu-id="e8201-108">:::no-loc(SignalR)::: クライアント ライブラリを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-108">Add the :::no-loc(SignalR)::: client library</span></span>
> * <span data-ttu-id="e8201-109">:::no-loc(SignalR)::: ハブを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-109">Add a :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="e8201-110">:::no-loc(SignalR)::: サービスと :::no-loc(SignalR)::: ハブのエンドポイントを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-110">Add :::no-loc(SignalR)::: services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="e8201-111">チャット用の :::no-loc(Razor)::: コンポーネント コードを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-111">Add :::no-loc(Razor)::: component code for chat</span></span>
...
## <a name="create-a-hosted-no-locblazor-webassembly-app-project"></a><span data-ttu-id="e8201-127">ホストされる :::no-loc(Blazor WebAssembly)::: アプリ プロジェクトを作成する</span><span class="sxs-lookup"><span data-stu-id="e8201-127">Create a hosted :::no-loc(Blazor WebAssembly)::: app project</span></span>
...
1. <span data-ttu-id="e8201-133">**[:::no-loc(Blazor)::: アプリ]** を選択し、 **[次へ]** を選択します</span><span class="sxs-lookup"><span data-stu-id="e8201-133">Select **:::no-loc(Blazor)::: App** and select **Next**.</span></span>

1. <span data-ttu-id="e8201-134">**[プロジェクト名]** フィールドに「`:::no-loc(Blazor)::::::no-loc(SignalR):::App`」と入力します。</span><span class="sxs-lookup"><span data-stu-id="e8201-134">Type `:::no-loc(Blazor)::::::no-loc(SignalR):::App` in the **Project name** field.</span></span> <span data-ttu-id="e8201-135">**[場所]** エントリが正しいことを確認します。または、プロジェクトの場所を指定します。</span><span class="sxs-lookup"><span data-stu-id="e8201-135">Confirm the **Location** entry is correct or provide a location for the project.</span></span> <span data-ttu-id="e8201-136">**[作成]** を選択します。</span><span class="sxs-lookup"><span data-stu-id="e8201-136">Select **Create**.</span></span>

1. <span data-ttu-id="e8201-137">**:::no-loc(Blazor WebAssembly)::: アプリ** テンプレートを選択します。</span><span class="sxs-lookup"><span data-stu-id="e8201-137">Choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span>
...
1. <span data-ttu-id="e8201-149">**:::no-loc(Blazor WebAssembly)::: アプリ** テンプレートを選択します。</span><span class="sxs-lookup"><span data-stu-id="e8201-149">Choose the **:::no-loc(Blazor WebAssembly)::: App** template.</span></span> <span data-ttu-id="e8201-150">**[次へ]** を選択します。</span><span class="sxs-lookup"><span data-stu-id="e8201-150">Select **Next**.</span></span>
...
1. <span data-ttu-id="e8201-154">**[プロジェクト名]** フィールドで、アプリに `:::no-loc(Blazor)::::::no-loc(SignalR):::App` という名前を付けます。</span><span class="sxs-lookup"><span data-stu-id="e8201-154">In the **Project Name** field, name the app `:::no-loc(Blazor)::::::no-loc(SignalR):::App`.</span></span> <span data-ttu-id="e8201-155">**[作成]** を選択します。</span><span class="sxs-lookup"><span data-stu-id="e8201-155">Select **Create**.</span></span>
...
## <a name="add-the-no-locsignalr-client-library"></a><span data-ttu-id="e8201-161">:::no-loc(SignalR)::: クライアント ライブラリを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-161">Add the :::no-loc(SignalR)::: client library</span></span>
...
1. <span data-ttu-id="e8201-163">**ソリューション エクスプローラー** で、`:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` プロジェクトを右クリックし、 **[NuGet パッケージの管理]** を選択します。</span><span class="sxs-lookup"><span data-stu-id="e8201-163">In **Solution Explorer** , right-click the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="e8201-165">**[参照]** が選択されている状態で、検索ボックスに「`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`」と入力します。</span><span class="sxs-lookup"><span data-stu-id="e8201-165">With **Browse** selected, type `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` in the search box.</span></span>

1. <span data-ttu-id="e8201-166">検索結果から [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) パッケージを選択し、 **[インストール]** を選択します。</span><span class="sxs-lookup"><span data-stu-id="e8201-166">In the search results, select the [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) package and select **Install**.</span></span>
...
1. <span data-ttu-id="e8201-172">**[ソリューション]** サイドバーで、`:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` プロジェクトを右クリックし、 **[NuGet パッケージの管理]** を選択します。</span><span class="sxs-lookup"><span data-stu-id="e8201-172">In the **Solution** sidebar, right-click the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="e8201-174">**[参照]** が選択されている状態で、検索ボックスに「`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`」と入力します。</span><span class="sxs-lookup"><span data-stu-id="e8201-174">With **Browse** selected, type `Microsoft.AspNetCore.:::no-loc(SignalR):::.Client` in the search box.</span></span>

1. <span data-ttu-id="e8201-175">検索結果の [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) パッケージの横にあるチェック ボックスをオンにし、 **[パッケージの追加]** を選択します。</span><span class="sxs-lookup"><span data-stu-id="e8201-175">In the search results, select the check box next to the [`Microsoft.AspNetCore.:::no-loc(SignalR):::.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.:::no-loc(SignalR):::.Client) package and select **Add Package**.</span></span>
...
## <a name="add-a-no-locsignalr-hub"></a><span data-ttu-id="e8201-179">:::no-loc(SignalR)::: ハブを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-179">Add a :::no-loc(SignalR)::: hub</span></span>

<span data-ttu-id="e8201-180">`:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` プロジェクトで、`Hubs` (複数形) フォルダーを作成し、次の `ChatHub` クラス (`Hubs/ChatHub.cs`) を追加します。</span><span class="sxs-lookup"><span data-stu-id="e8201-180">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` project, create a `Hubs` (plural) folder and add the following `ChatHub` class (`Hubs/ChatHub.cs`):</span></span>
...
## <a name="add-services-and-an-endpoint-for-the-no-locsignalr-hub"></a><span data-ttu-id="e8201-181">サービスと :::no-loc(SignalR)::: ハブのエンドポイントを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-181">Add services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>

1. <span data-ttu-id="e8201-182">`:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` プロジェクトで、`Startup.cs` ファイルを開きます。</span><span class="sxs-lookup"><span data-stu-id="e8201-182">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Server` project, open the `Startup.cs` file.</span></span>
...
1. <span data-ttu-id="e8201-184">:::no-loc(SignalR)::: および応答の圧縮ミドルウェア サービスを `Startup.ConfigureServices` に追加します。</span><span class="sxs-lookup"><span data-stu-id="e8201-184">Add :::no-loc(SignalR)::: and Response Compression Middleware services to `Startup.ConfigureServices`:</span></span>
...
## <a name="add-no-locrazor-component-code-for-chat"></a><span data-ttu-id="e8201-188">チャット用の :::no-loc(Razor)::: コンポーネント コードを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-188">Add :::no-loc(Razor)::: component code for chat</span></span>

1. <span data-ttu-id="e8201-189">`:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` プロジェクトで、`Pages/Index.razor` ファイルを開きます。</span><span class="sxs-lookup"><span data-stu-id="e8201-189">In the `:::no-loc(Blazor)::::::no-loc(SignalR):::App.Client` project, open the `Pages/Index.razor` file.</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="e8201-226">:::no-loc(Blazor WebAssembly)::: でホストされるアプリ プロジェクトを作成する</span><span class="sxs-lookup"><span data-stu-id="e8201-226">Create a :::no-loc(Blazor WebAssembly)::: Hosted app project</span></span>
> * <span data-ttu-id="e8201-227">:::no-loc(SignalR)::: クライアント ライブラリを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-227">Add the :::no-loc(SignalR)::: client library</span></span>
> * <span data-ttu-id="e8201-228">:::no-loc(SignalR)::: ハブを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-228">Add a :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="e8201-229">:::no-loc(SignalR)::: サービスと :::no-loc(SignalR)::: ハブのエンドポイントを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-229">Add :::no-loc(SignalR)::: services and an endpoint for the :::no-loc(SignalR)::: hub</span></span>
> * <span data-ttu-id="e8201-230">チャット用の :::no-loc(Razor)::: コンポーネント コードを追加する</span><span class="sxs-lookup"><span data-stu-id="e8201-230">Add :::no-loc(Razor)::: component code for chat</span></span>

<span data-ttu-id="e8201-231">:::no-loc(Blazor)::: アプリの構築について詳しくは、:::no-loc(Blazor)::: のドキュメントを参照してください。</span><span class="sxs-lookup"><span data-stu-id="e8201-231">To learn more about building :::no-loc(Blazor)::: apps, see the :::no-loc(Blazor)::: documentation:</span></span>

> [!div class="nextstepaction"]
> <span data-ttu-id="e8201-232"><xref:blazor/index>
> [:::no-loc(Identity)::: Server、WebSockets、Server-Sent Events によるベアラー トークン認証](xref:signalr/authn-and-authz#bearer-token-authentication)</span><span class="sxs-lookup"><span data-stu-id="e8201-232"><xref:blazor/index>
...
* [<span data-ttu-id="e8201-234">認証のための :::no-loc(SignalR)::: のクロスオリジンネゴシエーション</span><span class="sxs-lookup"><span data-stu-id="e8201-234">:::no-loc(SignalR)::: cross-origin negotiation for authentication</span></span>](xref:blazor/fundamentals/additional-scenarios#signalr-cross-origin-negotiation-for-authentication)

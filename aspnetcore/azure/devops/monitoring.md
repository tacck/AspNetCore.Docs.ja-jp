...
## <a name="basic-monitoring-and-troubleshooting"></a><span data-ttu-id="f3e3a-113">基本的な監視とトラブルシューティング</span><span class="sxs-lookup"><span data-stu-id="f3e3a-113">Basic monitoring and troubleshooting</span></span>

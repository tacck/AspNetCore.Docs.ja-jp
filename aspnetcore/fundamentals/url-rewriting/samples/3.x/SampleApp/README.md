# <a name="aspnet-core-url-rewriting-sample"></a><span data-ttu-id="96424-101">ASP.NET Core の URL リライト サンプル</span><span class="sxs-lookup"><span data-stu-id="96424-101">ASP.NET Core URL Rewriting Sample</span></span>
